...
def procesar_analisis(archivo, instrucciones):
    """
    Procesa el archivo subido desde el panel principal de app.py utilizando la API Key guardada en las variables de entorno.
    """
    ...
    try:
        ...
        if nombre.endswith('.docx'):
            ...
            contenido_texto = f"Documento subido: {nombre}"
